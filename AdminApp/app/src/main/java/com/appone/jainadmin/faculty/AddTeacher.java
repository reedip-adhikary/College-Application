...
import com.appone.jainadmin.NoticeData;
import com.appone.jainadmin.R;
import com.appone.jainadmin.UploadNotice;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Computer Science", "Mechanical", "Electrical", "Aerospace"};
    ...
    private void checkValidation() {
        ...
        if(name.isEmpty()){
            addTeacherName.setError("Add Name");
            addTeacherName.requestFocus();
        }else if(email.isEmpty()){
            addTeacherEmail.setError("Add Email");
            addTeacherEmail.requestFocus();
        }else if(post.isEmpty()){
            addTeacherPost.setError("Add Post");
